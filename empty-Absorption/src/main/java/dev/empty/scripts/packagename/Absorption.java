...
import dev.empty.scripts.packagename.tasks.TaskOne;
import dev.empty.scripts.packagename.tasks.TaskThree;
import dev.empty.scripts.packagename.tasks.TaskTwo;
...
@Extension
public class Absorption extends Script
{
